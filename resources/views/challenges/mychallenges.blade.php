        ...
        <div class="row challenge-item"  style="margin-bottom: 50px;padding:0">
            ...
            <div class="grid2 small-img">
                    ...
                    @switch($item['photocount'])
                        ...
                        <div style="text-align: center;width: 100%;padding: 0px;">
                            <div class="col-12" style="padding: 0px;">
                                <div class="" style="text-align: center;width: 87px;margin: auto">
                        ...
                        <div class=" row" style="text-align: center;width: 100%;padding: 0px;">
                            ...
                            <div class="col-6" style="text-align: center;margin: auto">
                                <div id="iid-0-{{$item['id']}}-div" style="width: 87px;margin: auto;">
                                    <img id="iid-0-{{$item['id']}}" src="{{asset('img/questionmark.jpg')}}">
                                    <span id="voteid-0-{{$item['id']}}"></span>
                                    <span id="imageid-0-{{$item['id']}}" style="display: none"></span>
                                </div>
                            ...
                            <div class="col-6" style="text-align: center;margin: auto">
                                <div id="iid-1-{{$item['id']}}-div" style="width: 87px;margin: auto;">
                ...
                <div class="row" style="margin-top: 30px; padding: 0">
                    <div class="challenge-btn col-6">
                        <button class="btn btn-light" style="text-align: center" onclick="onpress_swap('{{$item['id']}}','{{$item['photocount']}}')"> <h9>FLIP</h9></button>
                    </div>
                    <div class="challenge-btn col-6">
            ...
            <div class="grid3 e-bound">
                <div class="row" style="padding: 0px;font-size:17px;font-weight:bold;">
                    <div class="col-12" style="margin-bottom: 10px">Express Bound</div>


                    <div class="col-12" style="padding: 0;">
                        <div class="row">
                            <div class="col-4 icon" >
                                <span style="right:9%;">vote</span>
                                <a href={{asset('../challenges/voting/'.$item['id'])}} class="">
                                    <img style="right: 9%" src="http://ajronitesting.com/PixPays/wp-content/themes/PixPays/img/ebicon.png" alt="">
                                </a>
                            ...
                            <div class="col-4 icon" >
                                <span style="left:0">charge</span>
                                <img onclick="onpress_charge('{{$item['id']}}')" style="left: 5%" src="http://ajronitesting.com/PixPays/wp-content/themes/PixPays/img/ebicon2.png" alt="">
            ...
            <div class="grid4 ">
                <div class="row last-item">
                    <div class="col-6" style="border-right: solid 2px #e9ecef;">
                    ...
                    <div class="col-6" style="border-left: solid 2px #e9ecef;">
                        <h5>
                            PIX POINTS
                        </h5>
                        <div class="points">
                        ...
                        <div class="shair-link">
                            <a href="http://urpixpays.com/publicsite/invite"><h5>Invite Friends</h5></a>
                        </div>
                    </div>
                    <!--<div class="col-4">-->
                    <!--    <h5>ACHIEVEMENT</h5>-->
                    ...
                    <!--    </div>-->
                    <!--    <button data-modal-trigger="shairm" class="trigger"><i class="fa fa-share-alt" aria-hidden="true"></i>Shair Rank</button>-->
                    <!--</div>-->
