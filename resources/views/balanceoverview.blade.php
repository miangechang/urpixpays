 ...
 <main class="page-content">
    ...
    <div class="row" style="margin: 10px; margin-top:100px;" >
        <div class="col-md-4 col-sm-12" style="background-color: white;height: 100px">
            ...
            <span style="font-size: 2.5rem">$<?php echo $balence ?></span>
    ...
    <div class = "row">
        <div class="wrapper col-6">  
            <ul class="navigation">
              <a class="main" href="#url">Deposit by ...</a>
              <li class="n1"><a href={{url('/paypal')}}>Paypal</a></li>
              <li class="n2"><a href={{url('/admin_login')}}>Strip</a></li> 
            </ul>
        </div>
        <div class="wrapper col-6">  
            <ul class="navigation">
              ...
              <li class="n2"><a href={{url('/withdraw_strip')}}>Strip</a></li> 
            </ul>
        </div>
    </div>
